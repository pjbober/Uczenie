...
/**
 * Based on BasicSurfer by Voidious (Public Domain)
 * http://robowiki.net/wiki/BasicSurfer
 */
public class AvoidingStrategy extends BaseStrategy {
	...
	public AvoidingStrategy(AdvancedRobot robot) {
		super(robot);
	}
