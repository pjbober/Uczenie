...
import piqle.algorithms.IStrategyLearner;
import piqle.dataset.Dataset;
import piqle.environment.AbstractComposedAction;
import piqle.environment.ComposedActionArrayList;
...
abstract public class AbstractSwarm extends LoneAgent{
    ...
    /** TODO : find a correct definition of piqle.dataset in this case... */
