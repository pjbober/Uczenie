...
public class TwoPlayerAgent extends AbstractAgent{
   ...
   // protected IState oldState; 
      ...
      /** Place this agent somewhere in the piqle.environment, set its choice algorithm. */
    ...
    /** The referee  tells the agent the new state of the piqle.environment after
     * its opponent played.
     @param s The state of the piqle.environment after the opponent played.
*/
