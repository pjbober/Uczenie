...
public class NullableAction implements IAction {
	 ...
	 * <li> Initial action in initial state for elementary multi-piqle.agents.w/li>
	 * </ul>
	 */
	static public NullableAction nullAction=null;
	/* (non-Javadoc)
	 * @see piqle.environment.IAction#copy()
	 */
	public Object copy(){
	...
	/* (non-Javadoc)
	 * @see piqle.environment.IAction#isNullAction()
	 */
	...
	/* (non-Javadoc)
	 * @see piqle.environment.IAction#nnCoding()
	 */
