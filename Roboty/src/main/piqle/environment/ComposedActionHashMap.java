...
public class ComposedActionHashMap extends AbstractComposedAction {
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#addElementaryAction(piqle.agents.ElementaryAgent, piqle.environment.IAction)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#getAction(piqle.agents.ElementaryAgent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#getAction(int)
	 */
	@Override
