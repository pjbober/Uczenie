...
import piqle.agents.ElementaryAgent;
...
public class ComposedActionArrayList extends AbstractComposedAction 
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#copy()
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#equals(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#hashCode()
	 */
	@Override
	public int hashCode() {
		ArrayList<IAction> thisList=(ArrayList<IAction>)this.list;
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#nnCoding()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see piqle.environment.AbstractComposedAction#nnCodingSize()
	 */
	@Override
