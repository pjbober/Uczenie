...
import piqle.qlearning.Eligibles;
import piqle.environment.IAction;
import piqle.environment.IState;
import piqle.qlearning.IDefaultValueChooser;

/** 
    Common settings and behaviors of Q(lambda) piqle.algorithms<p>
...
abstract public class AbstractQLambdaSelector extends QLearningSelector{
 /** The new parameter for that family of piqle.algorithms */
