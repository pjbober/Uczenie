...
public class RectangularTiling extends Tiling{
    ...
    /** Shift of the piqle.tiling (less than one square) */
    private double shiftx,shifty; 
    
    /** Origin of the piqle.tiling (after adding one tile, and shift the entire piqle.tiling) */
    private double xOrigin, yOrigin; 

    /** Number of tiles on each side */
    private int nbDivisionsX,nbDivisionsY; 

    /** Defines a new piqle.tiling.
    ...
    */
    ...
    /** We don't use this way of acquiring a tile in rectangular piqle.tiling  .... */
