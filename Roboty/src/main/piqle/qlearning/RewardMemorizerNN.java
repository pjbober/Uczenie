...
import piqle.neuralnetwork.NeuralNetwork;
import piqle.dataset.Dataset;
import piqle.dataset.Sample;
...
At some moments, the <code>Sample</code>s gathered into a <code>Dataset</code> are fed into a neural network, which is asked to learn Q(s,a) from this piqle.dataset.<br>
...
public class RewardMemorizerNN implements IRewardStore{
    ...
    /** The maximum number of Samples contained into the piqle.dataset.*/
    ...
    /** No piqle.dataset extraction at this time (september 2005,USTL ) */
